...
describe('Security', function() {
  ...
  afterEach(async function() {
	...
	it('WebFirewall(Self)', async function() {
		...
		sleep(1000)
		assert(await driver.findElement(By.xpath("//h4[contains(.,\'WEB Firewall (Self)\')]")).getText() == "WEB Firewall (Slf)")
		...
		sleep(1000)
		assert(await driver.findElement(By.xpath("//div[@id=\'security-web-firewall\']/div[2]/em/span")).getText() == "800,000")
